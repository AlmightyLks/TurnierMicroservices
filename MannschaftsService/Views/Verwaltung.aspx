...
<body>
    <form id="form1" runat="server">
        ...
        <div style="width: 100%; text-align: center;">
            <asp:Button ID="AddMannschaftButton" runat="server" Visible="false" Text="Mannschaft hinzufügen" OnClick="AddMannschaftButton_Click" Height="30px" Width="193px" />
            <asp:Button ID="CancelButton" runat="server" OnClick="CancelButton_Click" Text="Abbrechen" Visible="False" Height="30px" Width="99px" />
            <br />
            <br />
